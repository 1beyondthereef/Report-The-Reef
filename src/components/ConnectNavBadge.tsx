...
export function ConnectNavBadge() {
  ...
  return (
    <span className="absolute -top-6 left-1/2 -translate-x-1/2 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-[10px] font-bold text-white shadow-md">
