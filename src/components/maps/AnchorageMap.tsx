...
export function AnchorageMap<T extends BaseAnchorage>({ anchorages, selectedId, onSelect, className }: AnchorageMapProps<T>) {
  ...
  // Update markers when anchorages change
  useEffect(() => {
  ...
  }, [anchorages, selectedId, isLoaded, onSelect]);
